...
// Copyright (c) 2011-2012 PAPAFRANCESCOCoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("PAPAFRANCESCOCoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #PAPAFRANCESCOCoinTEST0\r");
            Send(hSocket, "WHO #PAPAFRANCESCOCoinTEST0\r");
        } else {
            // randomly join #PAPAFRANCESCOCoin00-#PAPAFRANCESCOCoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #PAPAFRANCESCOCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #PAPAFRANCESCOCoin%02d\r", channel_number).c_str());
        }
